package com.gio.rest.webservices.restfulwebservices.exception;
...
import com.gio.rest.webservices.restfulwebservices.user.UserNotFoundException;

@ControllerAdvice // shares exception amongst all controller classes
@RestController
...
extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		ExceptionResponse excResponse =  new ExceptionResponse(new Date(), "Vaildation Failed", 
